...
if confirm "Proceed with installing latest NGINX with Brotli and HTTP/3 support?"; then
  ...
  ./configure --with-compat --add-dynamic-module=../ngx_brotli --with-http_v3_module --with-http_ssl_module --with-http_v2_module --with-stream_quic_module --with-stream_ssl_module
  make
  make install
